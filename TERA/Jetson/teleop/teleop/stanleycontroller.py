import numpy as np
import TERA.Jetson.teleop.teleop.wayfinder as wayfinder
from TERA.Jetson.teleop.teleop.TERA_gps import GpsPublisher
...
def implementation():
    last_x, last_y = current_position
    current_position = GpsPublisher.get_gps_ENU()[0, 1]
