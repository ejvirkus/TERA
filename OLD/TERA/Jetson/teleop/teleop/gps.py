...
class GpsPublisher(Node):
    ...
    def publish_gps_data(self):
        ...
        if latitude is not None and longitude is not None and altitude is not None and direction is not None:
            gps_data_str = f"Latitude: {latitude}, Longitude: {longitude}, Altitude: {altitude}, Direction: {direction}"
            msg = String()
            ...
            self.csv_writer.writerow([latitude, longitude, altitude, direction])
